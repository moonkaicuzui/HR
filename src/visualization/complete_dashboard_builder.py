        ...
        <div class="card-body py-3">
            <div class="row text-center">
                ...
                <div class="col-md-3">
                    <div class="stat-item">
                        <div class="stat-label small opacity-75">
                            <span class="lang-stat" data-ko="개근률" data-en="Perfect Rate" data-vi="Tỷ lệ chuyên cần">개근률</span>
                        </div>
                        <div class="stat-value fs-4 fw-bold" id="statsPerfectRate">0%</div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="stat-item">
                        <div class="stat-label small opacity-75">
                            <span class="lang-stat" data-ko="평균 재직기간" data-en="Avg. Tenure" data-vi="Thâm niên TB">평균 재직기간</span>
                        </div>
                        <div class="stat-value fs-4 fw-bold" id="statsAvgTenure">0일</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-3">
            <div class="dropdown d-inline-block">
                <button class="btn btn-sm btn-outline-secondary dropdown-toggle" type="button" id="columnToggleBtn" data-bs-toggle="dropdown">
                    <span class="lang-btn" data-ko="열 표시" data-en="Columns" data-vi="Cột">열 표시</span>
                </button>
                <ul class="dropdown-menu p-2" id="columnToggleMenu" style="min-width: 200px;">
                    <li><label class="dropdown-item mb-0"><input type="checkbox" checked data-column="0" onchange="toggleColumn(0)"> <span class="lang-label" data-ko="사번" data-en="ID" data-vi="Mã">사번</span></label></li>
                    <li><label class="dropdown-item mb-0"><input type="checkbox" checked data-column="1" onchange="toggleColumn(1)"> <span class="lang-label" data-ko="이름" data-en="Name" data-vi="Tên">이름</span></label></li>
                    <li><label class="dropdown-item mb-0"><input type="checkbox" checked data-column="2" onchange="toggleColumn(2)"> <span class="lang-label" data-ko="직급" data-en="Position" data-vi="Vị trí">직급</span></label></li>
                    <li><label class="dropdown-item mb-0"><input type="checkbox" checked data-column="3" onchange="toggleColumn(3)"> <span class="lang-label" data-ko="유형" data-en="Type" data-vi="Loại">유형</span></label></li>
                    <li><label class="dropdown-item mb-0"><input type="checkbox" checked data-column="4" onchange="toggleColumn(4)"> <span class="lang-label" data-ko="건물" data-en="Building" data-vi="Tòa">건물</span></label></li>
                    <li><label class="dropdown-item mb-0"><input type="checkbox" checked data-column="5" onchange="toggleColumn(5)"> <span class="lang-label" data-ko="라인" data-en="Line" data-vi="Dây">라인</span></label></li>
                    <li><label class="dropdown-item mb-0"><input type="checkbox" checked data-column="6" onchange="toggleColumn(6)"> <span class="lang-label" data-ko="상사" data-en="Boss" data-vi="Cấp trên">상사</span></label></li>
                    <li><label class="dropdown-item mb-0"><input type="checkbox" checked data-column="7" onchange="toggleColumn(7)"> <span class="lang-label" data-ko="입사일" data-en="Entrance" data-vi="Ngày vào">입사일</span></label></li>
                    <li><label class="dropdown-item mb-0"><input type="checkbox" checked data-column="8" onchange="toggleColumn(8)"> <span class="lang-label" data-ko="퇴사일" data-en="Stop" data-vi="Ngày nghỉ">퇴사일</span></label></li>
                    <li><label class="dropdown-item mb-0"><input type="checkbox" checked data-column="9" onchange="toggleColumn(9)"> <span class="lang-label" data-ko="재직기간" data-en="Tenure" data-vi="Thâm niên">재직기간</span></label></li>
                    <li><label class="dropdown-item mb-0"><input type="checkbox" checked data-column="10" onchange="toggleColumn(10)"> <span class="lang-label" data-ko="상태" data-en="Status" data-vi="Trạng thái">상태</span></label></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-6">
            <div class="btn-group" role="group">
                <label class="btn btn-sm btn-outline-secondary">
                    ...
                    <span class="lang-btn" data-ko="전체 선택" data-en="Select All" data-vi="Chọn tất">전체 선택</span>
                </label>
                <button type="button" class="btn btn-sm btn-outline-success" id="exportSelectedBtn" onclick="exportSelected('csv')" disabled>
                    <span class="lang-btn" data-ko="선택 내보내기" data-en="Export Selected" data-vi="Xuất đã chọn">선택 내보내기</span>
                </button>
                <button type="button" class="btn btn-sm btn-outline-primary" id="printSelectedBtn" onclick="printSelected()" disabled>
                    <span class="lang-btn" data-ko="선택 인쇄" data-en="Print Selected" data-vi="In đã chọn">선택 인쇄</span>
                </button>
            </div>
            <span class="badge bg-secondary ms-2" id="selectedCount">0 선택됨</span>
        </div>
        ...
        <table class="table table-striped table-hover employee-table" id="employeeTable">
            <thead class="table-light sticky-top">
                <tr>
                    ...
                    <th class="sortable" onclick="sortTable(7)" id="th-7"><span class="lang-th" data-ko="입사일" data-en="Entrance" data-vi="Ngày vào">입사일</span> <span class="sort-indicator"></span></th>
                    <th class="sortable" onclick="sortTable(8)" id="th-8"><span class="lang-th" data-ko="퇴사일" data-en="Stop" data-vi="Ngày nghỉ">퇴사일</span> <span class="sort-indicator"></span></th>
                    <th class="sortable" onclick="sortTable(9)" id="th-9"><span class="lang-th" data-ko="재직기간" data-en="Tenure" data-vi="Thâm niên">재직기간</span> <span class="sort-indicator"></span></th>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="accordion" id="kpiAccordion">
                        ...
                        <!-- Add more KPI explanations as needed -->
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="lang-help-content"
                         data-ko="<h6>🔍 검색 및 필터링</h6>
                                  ...
                                  <h6>📥 데이터 내보내기</h6>
                                  <p>각 모달에서 데이터를 다운로드할 수 있습니다:</p>
                                  <ul>
                                    <li>Excel 형식으로 내보내기</li>
                                    <li>PDF 보고서 생성</li>
                                    <li>이미지로 저장</li>
                                  </ul>
                                  <h6>🔔 알림 설정</h6>
                                  <p>중요 지표 변화 시 알림을 받을 수 있습니다:</p>
                                  <ul>
                                    <li>결근율 임계값 초과 시</li>
                                    <li>이직률 급증 시</li>
                                    <li>신규 입사자 발생 시</li>
                         ...
                         data-en="<h6>🔍 Search and Filtering</h6>
                                  ...
                                  <ul>
                                    ...
                                    <li>Drag chart area to zoom</li>
                                  </ul>
                                  <h6>📥 Data Export</h6>
                                  <p>Download data from each modal:</p>
                                  <ul>
                                    <li>Export to Excel format</li>
                                    <li>Generate PDF reports</li>
                                    <li>Save as images</li>
                                  </ul>
                                  <h6>🔔 Notifications</h6>
                                  <p>Receive alerts on important metric changes:</p>
                                  <ul>
                                    <li>When absence rate exceeds threshold</li>
                                    <li>When turnover rate spikes</li>
                                    <li>When new hires occur</li>
                                  </ul>"
                         data-vi="<h6>🔍 Tìm kiếm và lọc</h6>
                                  ...
                                  <ul>
                                    ...
                                    <li>Kéo vùng biểu đồ để phóng to</li>
                                  </ul>
                                  <h6>📥 Xuất dữ liệu</h6>
                                  <p>Tải xuống dữ liệu từ mỗi cửa sổ:</p>
                                  <ul>
                                    <li>Xuất sang định dạng Excel</li>
                                    <li>Tạo báo cáo PDF</li>
                                    <li>Lưu dưới dạng hình ảnh</li>
                                  </ul>
                                  <h6>🔔 Thông báo</h6>
                                  <p>Nhận cảnh báo về thay đổi chỉ số quan trọng:</p>
                                  <ul>
                                    <li>Khi tỷ lệ vắng mặt vượt ngưỡng</li>
                                    <li>Khi tỷ lệ nghỉ việc tăng đột biến</li>
                                    <li>Khi có nhân viên mới</li>
                                  </ul>">
                        <h6>🔍 검색 및 필터링</h6>
                        <p><strong>Details 탭</strong>에서 직원 정보를 검색할 수 있습니다.</p>
                    </div>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button class="accordion-button collapsed lang-faq-title" type="button" data-bs-toggle="collapse" data-bs-target="#faq3"
                                        data-ko="Q3. 데이터를 엑셀로 내보낼 수 있나요?"
                                        data-en="Q3. Can I export data to Excel?"
                                        data-vi="Q3. Tôi có thể xuất dữ liệu sang Excel không?">
                                    Q3. 데이터를 엑셀로 내보낼 수 있나요?
                                </button>
                            </h2>
                            <div id="faq3" class="accordion-collapse collapse">
                                <div class="accordion-body lang-faq-content"
                                     data-ko="<strong>답변</strong>: 네, 각 모달창 하단의 '내보내기' 버튼을 클릭하면 현재 보고 있는 데이터를 Excel 파일로 다운로드할 수 있습니다."
                                     data-en="<strong>Answer</strong>: Yes, click the 'Export' button at the bottom of each modal to download the current view as an Excel file."
                                     data-vi="<strong>Trả lời</strong>: Có, nhấp vào nút 'Xuất' ở cuối mỗi cửa sổ để tải xuống chế độ xem hiện tại dưới dạng tệp Excel.">
                                    <strong>답변</strong>: 네, 모달창 하단의 '내보내기' 버튼을 클릭하세요.
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th>무단결근율 (Rate)</th>
                                        <th>총 인원 (Total)</th>
                                        <th>무단결근자 (Unauthorized)</th>
                                        <th>전월 대비 (vs Previous)</th>
                                        <th>상태 (Status)</th>
                                    </tr>
                                </thead>
...
function renderEmployeeTable(employees = null) {
    ...
    if (displayEmployees.length === 0) {
        tbody.innerHTML = '<tr><td colspan="12" class="text-center text-muted py-4">직원이 없습니다.</td></tr>';
...
function updateSelectionUI() {
    ...
    document.getElementById('selectedCount').textContent = `${count} 선택됨`;
...
function updateQuickStats(employees) {
    ...
    const perfect = employees.filter(e => e.perfect_attendance).length;
    const avgTenure = Math.round(employees.reduce((sum, e) => sum + (e.tenure_days || 0), 0) / employees.length);
    ...
    document.getElementById('statsPerfectRate').textContent = `${Math.round(perfect / employees.length * 100)}%`;
    document.getElementById('statsAvgTenure').textContent = `${avgTenure}일`;
}
