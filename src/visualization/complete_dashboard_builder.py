        ...
        <div class="col-md-3 text-end">
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu column-toggle-menu" id="columnToggleMenu">
                    ...
                    <!-- Category: Work Info / 근무정보 -->
                    <div class="column-category">
                        <div class="category-header">
                            <span class="lang-label" data-ko="🏢 근무정보" data-en="🏢 Work Info" data-vi="🏢 Thông tin công việc">🏢 근무정보</span>
                        </div>
                        <label class="column-item"><input type="checkbox" checked data-column="4" onchange="toggleColumn(4)"><span class="column-icon">🏢</span><span class="column-name lang-label" data-ko="건물" data-en="Building" data-vi="Tòa">건물</span></label>
                        <label class="column-item"><input type="checkbox" checked data-column="5" onchange="toggleColumn(5)"><span class="column-icon">📍</span><span class="column-name lang-label" data-ko="라인" data-en="Line" data-vi="Dây">라인</span></label>
                        <label class="column-item"><input type="checkbox" checked data-column="6" onchange="toggleColumn(6)"><span class="column-icon">👔</span><span class="column-name lang-label" data-ko="상사" data-en="Boss" data-vi="Cấp trên">상사</span></label>
                    </div>
                    ...
                    <div class="column-category">
                        ...
                        <label class="column-item"><input type="checkbox" checked data-column="7" onchange="toggleColumn(7)"><span class="column-icon">📥</span><span class="column-name lang-label" data-ko="입사일" data-en="Start Date" data-vi="Ngày vào">입사일</span></label>
                        <label class="column-item"><input type="checkbox" checked data-column="8" onchange="toggleColumn(8)"><span class="column-icon">📤</span><span class="column-name lang-label" data-ko="퇴사일" data-en="End Date" data-vi="Ngày nghỉ">퇴사일</span></label>
                        <label class="column-item"><input type="checkbox" checked data-column="9" onchange="toggleColumn(9)"><span class="column-icon">⏱️</span><span class="column-name lang-label" data-ko="재직기간" data-en="Tenure" data-vi="Thâm niên">재직기간</span></label>
                        <label class="column-item"><input type="checkbox" checked data-column="10" onchange="toggleColumn(10)"><span class="column-icon">🔵</span><span class="column-name lang-label" data-ko="상태" data-en="Status" data-vi="Trạng thái">상태</span></label>
                    </div>
                </div>
            </div>
        </div>
